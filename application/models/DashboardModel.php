...
class DashboardModel extends Ci_Model
{
	...
	public function addpreventivemay($item)
	{
		return $this->db->insert('preventive_maintenance_form_may', $item);
	}
	public function addpreventivejune($item)
	{
		return $this->db->insert('preventive_maintenance_form_june', $item);
	}
	public function addpreventivejuly($item)
	{
		return $this->db->insert('preventive_maintenance_form_july', $item);
	}
	public function addpreventiveaugust($item)
	{
		return $this->db->insert('preventive_maintenance_form_august', $item);
	}
	public function addpreventiveseptember($item)
	{
	...
	public function addpreventivenovember($item)
	{
		return $this->db->insert('preventive_maintenance_form_november', $item);
	}
	public function addpreventivedecember($item)
	{
		return $this->db->insert('preventive_maintenance_form_december', $item);
	}
    ...
    public function getpreventiveForm_may()
    {
        return $this->db->get('preventive_maintenance_form_may')->result_array();
    }
    public function getpreventiveForm_june()
    {
        return $this->db->get('preventive_maintenance_form_june')->result_array();
    }
    public function getpreventiveForm_july()
    {
        return $this->db->get('preventive_maintenance_form_july')->result_array();
    }
    public function getpreventiveForm_august()
    {
        return $this->db->get('preventive_maintenance_form_august')->result_array();
    }
    ...
    public function getpreventiveForm_november()
    {
        return $this->db->get('preventive_maintenance_form_november')->result_array();
    }
    public function getpreventiveForm_december()
    {
        return $this->db->get('preventive_maintenance_form_december')->result_array();
    }
    ...
    public function hapuspreventivemay($id)
	{
        $this->db->where('id', $id);
	  	$this->db->delete("preventive_maintenance_form_may");	  	
	}
    public function hapuspreventivejune($id)
	{
        $this->db->where('id', $id);
	  	$this->db->delete("preventive_maintenance_form_june");	  	
	}
    public function hapuspreventivejuly($id)
	{
        $this->db->where('id', $id);
	  	$this->db->delete("preventive_maintenance_form_july");	  	
	}
    public function hapuspreventiveaugust($id)
	{
        $this->db->where('id', $id);
	  	$this->db->delete("preventive_maintenance_form_august");	  	
	}
    public function hapuspreventiveseptember($id)
	{
        $this->db->where('id', $id);
    ...
    public function hapuspreventivenovember($id)
	{
        $this->db->where('id', $id);
	  	$this->db->delete("preventive_maintenance_form_november");	  	
	}
    public function hapuspreventivedecember($id)
	{
        $this->db->where('id', $id);
	  	$this->db->delete("preventive_maintenance_form_december");	  	
	}
	...
	public function edit_preventive_may($id)
	{
		return $this->db->get_where('preventive_maintenance_form_may', ['id' => $id])->row_array();
	}
	public function edit_preventive_june($id)
	{
		return $this->db->get_where('preventive_maintenance_form_june', ['id' => $id])->row_array();
	}
	public function edit_preventive_july($id)
	{
		return $this->db->get_where('preventive_maintenance_form_july', ['id' => $id])->row_array();
	}
	public function edit_preventive_august($id)
	{
		return $this->db->get_where('preventive_maintenance_form_august', ['id' => $id])->row_array();
	}
	...
	public function edit_preventive_november($id)
	{
		return $this->db->get_where('preventive_maintenance_form_november', ['id' => $id])->row_array();
	}
	public function edit_preventive_december($id)
	{
		return $this->db->get_where('preventive_maintenance_form_december', ['id' => $id])->row_array();
	}
	...
	public function editpreventivemay()
	{
		$preventive_maintenance_form_may = [
			"machine" => $this->input->post('machine', true),
			"description" => $this->input->post('description', true),
			"ww01_1" => $this->input->post('ww01_1', true),			
			"ww01_2" => $this->input->post('ww01_2', true),			
			...
			$this->db->where('id', $this->input->post('id'));
       		$this->db->update('preventive_maintenance_form_may', $preventive_maintenance_form_may);
	}
	public function editpreventivejune()
	{
		$preventive_maintenance_form_june = [
			"machine" => $this->input->post('machine', true),
			"description" => $this->input->post('description', true),
			"ww01_1" => $this->input->post('ww01_1', true),			
			"ww01_2" => $this->input->post('ww01_2', true),			
			...
			$this->db->where('id', $this->input->post('id'));
       		$this->db->update('preventive_maintenance_form_june', $preventive_maintenance_form_june);
	}
	public function editpreventivejuly()
	{
		$preventive_maintenance_form_july = [
			"machine" => $this->input->post('machine', true),
			"description" => $this->input->post('description', true),
			"ww01_1" => $this->input->post('ww01_1', true),			
			"ww02_2" => $this->input->post('ww02_2', true),			
			...
			"ww05_29" => $this->input->post('ww05_29', true),			
			"ww06_30" => $this->input->post('ww06_30', true),			
			"ww06_31" => $this->input->post('ww06_31', true),			
		];
			$this->db->where('id', $this->input->post('id'));
       		$this->db->update('preventive_maintenance_form_july', $preventive_maintenance_form_july);
	}
	public function editpreventiveaugust()
	{
		$preventive_maintenance_form_august = [
			"machine" => $this->input->post('machine', true),
			"description" => $this->input->post('description', true),
			"ww01_1" => $this->input->post('ww01_1', true),			
			"ww01_2" => $this->input->post('ww01_2', true),			
			...
			$this->db->where('id', $this->input->post('id'));
       		$this->db->update('preventive_maintenance_form_august', $preventive_maintenance_form_august);
	}
	public function editpreventiveseptember()
	{
		$preventive_maintenance_form_september = [
			"machine" => $this->input->post('machine', true),
			"description" => $this->input->post('description', true),
			"ww01_1" => $this->input->post('ww01_1', true),			
			"ww01_2" => $this->input->post('ww01_2', true),			
	...
	public function editpreventivenovember()
	{
		$preventive_maintenance_form_november = [
			"machine" => $this->input->post('machine', true),
			"description" => $this->input->post('description', true),
			"ww01_1" => $this->input->post('ww01_1', true),			
			"ww01_2" => $this->input->post('ww01_2', true),			
			...
			$this->db->where('id', $this->input->post('id'));
       		$this->db->update('preventive_maintenance_form_november', $preventive_maintenance_form_november);
	}
	public function editpreventivedecember()
	{
		$preventive_maintenance_form_december = [
			"machine" => $this->input->post('machine', true),
			"description" => $this->input->post('description', true),
			"ww01_1" => $this->input->post('ww01_1', true),			
			"ww01_2" => $this->input->post('ww01_2', true),			
			...
			$this->db->where('id', $this->input->post('id'));
       		$this->db->update('preventive_maintenance_form_december', $preventive_maintenance_form_december);
	}
