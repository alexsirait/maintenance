          ...
          <div class="card-body col-sm-12">
            ...
            <div class="dropdown">
              <div class="mb-2 mr-2" style="float: left;">	
                <a class="btn btn-primary float-right" href="<?php echo base_url(); ?>dashboard/add_maintenance_august" style="color:black"><i class="fas fa-plus"></i> <b>Add Data</b></a>
              </div>
                  ...
                  <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th style="white-space:nowrap;" class="text-center" colspan="32"><b>August</th>
                        ...
                        <tr>
                          ...
                          <td align=center style="white-space:nowrap;" colspan="5">WW-01</td>
                          ...
                          <td align=center style="white-space:nowrap;" colspan="5">WW-05</td>                          
                      ...
                      <tbody>
                      <?php if ($preventive_maintenance_form_august != null) : ?>
                      <?php $i = 1;
                        foreach ($preventive_maintenance_form_august as $item) { ?>
                        <tr>
                          ...
                          <td align=center style="white-space:nowrap;">
                            <a class="btn btn-info btn-sm m-1" href="<?= base_url(); ?>Dashboard/ubah_preventive_august/<?= $item['id']?>" style="color: black"><i class="fas fa-solid fa-pencil-alt"></i></a>
                            <a href="<?= base_url() ?>Dashboard/deleteReportPreventiveAugust/<?= $item['id']?>" onclick="return confirm('Hapus?');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                          </td>                          
                        </tr>
                        <?php } ?>
                        <?php endif; ?>                        
