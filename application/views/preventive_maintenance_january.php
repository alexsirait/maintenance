          ...
          <div class="card-body col-sm-12">
            ...
            <div class="dropdown">
              <div class="mb-2 mr-2" style="float: left;">	
                <a class="btn btn-primary float-right" href="<?php echo base_url(); ?>dashboard/add_maintenance_january" style="color:black"><i class="fas fa-plus"></i> <b>Add Data</b></a>
              </div>
                  ...
                  <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                      <thead class="thead-light">
                        ...
                        <tr>
                          ...
                          <td align=center style="white-space:nowrap;" colspan="7">WW-01</td>
                      ...
                      <tbody>
                      <?php if ($preventive_maintenance_form_january != null) : ?>
                      <?php $i = 1;
                        foreach ($preventive_maintenance_form_january as $item) { ?>
                        <tr>
                          ...
                          <td align=center style="white-space:nowrap;"><?php if($item['ww01_5'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww01_5'] . '</div>'; }elseif ($item['ww01_5'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww01_5']; } elseif ($item['ww01_5'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww01_5']; } elseif ($item['ww01_5'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww01_5']; } ?></td>
                          <td align=center style="white-space:nowrap;"><?php if($item['ww01_6'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww01_6'] . '</div>'; }elseif ($item['ww01_6'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww01_6']; } elseif ($item['ww01_6'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww01_6']; } elseif ($item['ww01_6'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww01_6']; } ?></td>
                          <td align=center style="white-space:nowrap;"><?php if($item['ww01_7'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww01_7'] . '</div>'; }elseif ($item['ww01_7'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww01_7']; } elseif ($item['ww01_7'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww01_7']; } elseif ($item['ww01_7'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww01_7']; } ?></td>
                          ...
                          <td align=center style="white-space:nowrap;"><?php if($item['ww02_12'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww02_12'] . '</div>'; }elseif ($item['ww02_12'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww02_12']; } elseif ($item['ww02_12'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww02_12']; } elseif ($item['ww02_12'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww02_12']; } ?></td>
                          <td align=center style="white-space:nowrap;"><?php if($item['ww02_13'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww02_13'] . '</div>'; }elseif ($item['ww02_13'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww02_13']; } elseif ($item['ww02_13'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww02_13']; } elseif ($item['ww02_13'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww02_13']; } ?></td>
                          <td align=center style="white-space:nowrap;"><?php if($item['ww02_14'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww02_14'] . '</div>'; }elseif ($item['ww02_14'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww02_14']; } elseif ($item['ww02_14'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww02_14']; } elseif ($item['ww02_14'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww02_14']; } ?></td>
                          ...
                          <td align=center style="white-space:nowrap;"><?php if($item['ww03_19'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww03_19'] . '</div>'; }elseif ($item['ww03_19'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww03_19']; } elseif ($item['ww03_19'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww03_19']; } elseif ($item['ww03_19'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww03_19']; } ?></td>
                          <td align=center style="white-space:nowrap;"><?php if($item['ww03_20'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww03_20'] . '</div>'; }elseif ($item['ww03_20'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww03_20']; } elseif ($item['ww03_20'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww03_20']; } elseif ($item['ww03_20'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww03_20']; } ?></td>
                          <td align=center style="white-space:nowrap;"><?php if($item['ww03_21'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww03_21'] . '</div>'; }elseif ($item['ww03_21'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww03_21']; } elseif ($item['ww03_21'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww03_21']; } elseif ($item['ww03_21'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww03_21']; } ?></td>
                          ...
                          <td align=center style="white-space:nowrap;"><?php if($item['ww04_26'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww04_26'] . '</div>'; }elseif ($item['ww04_26'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww04_26']; } elseif ($item['ww04_26'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww04_26']; } elseif ($item['ww04_26'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww04_26']; } ?></td>
                          <td align=center style="white-space:nowrap;"><?php if($item['ww04_27'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww04_27'] . '</div>'; }elseif ($item['ww04_27'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww04_27']; } elseif ($item['ww04_27'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww04_27']; } elseif ($item['ww04_27'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww04_27']; } ?></td>
                          <td align=center style="white-space:nowrap;"><?php if($item['ww04_28'] == 'D'){ echo '<div class="badge bg-success text-white p-2">' . $item['ww04_28'] . '</div>'; }elseif ($item['ww04_28'] == 'P/C') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww04_28']; } elseif ($item['ww04_28'] == 'P') { echo '<div class="badge bg-warning text-white p-2">' . $item['ww04_28']; } elseif ($item['ww04_28'] == 'U/R') { echo '<div class="badge bg-danger text-white p-2">' . $item['ww04_28']; } ?></td>
                          ...
                          <td align=center style="white-space:nowrap;"><?= $item['ww01_5'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww01_6'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww01_7'] ?></td>
                          ...
                          <td align=center style="white-space:nowrap;"><?= $item['ww02_12'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww02_13'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww02_14'] ?></td>
                          ...
                          <td align=center style="white-space:nowrap;"><?= $item['ww03_20'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww03_21'] ?></td>
                          ...
                          <td align=center style="white-space:nowrap;"><?= $item['ww04_26'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww04_27'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww04_28'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww05_29'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww05_30'] ?></td>
                          <td align=center style="white-space:nowrap;"><?= $item['ww05_31'] ?></td> -->
                          <td align=center style="white-space:nowrap;">
                            <a class="btn btn-info btn-sm m-1" href="<?= base_url(); ?>Dashboard/ubah_preventive_january/<?= $item['id']?>" style="color: black"><i class="fas fa-solid fa-pencil-alt"></i></a>
                            <a href="<?= base_url() ?>Dashboard/deleteReportPreventiveJanuary/<?= $item['id']?>" onclick="return confirm('Hapus?');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                          </td>                          
                        </tr>
                        <?php } ?>
                        <?php endif; ?>                        
