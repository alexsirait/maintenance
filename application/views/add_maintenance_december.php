    ...
    <section class="content">
      ...
      <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Planned Preventive Maintenance December Form</h6>
          </div>
            <div class="card-body">
              <form action="<?php echo base_url(); ?>Dashboard/save_preventive_december" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" required="required">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                      <label for="Sun">Sun |</label>
                      <select name="ww04_16"31lass='form-control'>
                        <option value=""></option>
                        <option value="D">D</option>
                        <option value="P/C">P/C</option>
                        <option value="P">P</option>
