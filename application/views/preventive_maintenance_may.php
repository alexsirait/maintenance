          ...
          <div class="card-body col-sm-12">
            ...
            <div class="dropdown">
              <div class="mb-2 mr-2" style="float: left;">	
                <a class="btn btn-primary float-right" href="<?php echo base_url(); ?>dashboard/add_maintenance_may" style="color:black"><i class="fas fa-plus"></i> <b>Add Data</b></a>
              </div>
                  ...
                  <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                      <thead class="thead-light">
                        ...
                        <tr>
                          ...
                          <td align=center style="white-space:nowrap;" colspan="6">WW-01</td>
                          ...
                          <td align=center style="white-space:nowrap;" colspan="4">WW-05</td>                          
                      ...
                      <tbody>
                      <?php if ($preventive_maintenance_form_may != null) : ?>
                      <?php $i = 1;
                        foreach ($preventive_maintenance_form_may as $item) { ?>
                        <tr>
                          ...
                          <td align=center style="white-space:nowrap;">
                            <a class="btn btn-info btn-sm m-1" href="<?= base_url(); ?>Dashboard/ubah_preventive_may/<?= $item['id']?>" style="color: black"><i class="fas fa-solid fa-pencil-alt"></i></a>
                            <a href="<?= base_url() ?>Dashboard/deleteReportPreventiveMay/<?= $item['id']?>" onclick="return confirm('Hapus?');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                          </td>                          
                        </tr>
                        <?php } ?>
                        <?php endif; ?>                        
