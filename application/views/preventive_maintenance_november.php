          ...
          <div class="card-body col-sm-12">
            ...
            <div class="dropdown">
              <div class="mb-2 mr-2" style="float: left;">	
                <a class="btn btn-primary float-right" href="<?php echo base_url(); ?>dashboard/add_maintenance_november" style="color:black"><i class="fas fa-plus"></i> <b>Add Data</b></a>
              </div>
              ...
              <div class="table-responsive">
                  <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                      ...
                      <tbody>
                      <?php if ($preventive_maintenance_form_november != null) : ?>
                      <?php $i = 1;
                        foreach ($preventive_maintenance_form_november as $item) { ?>
                        <tr>
                          ...
                          <td align=center style="white-space:nowrap;">
                            <a class="btn btn-info btn-sm m-1" href="<?= base_url(); ?>Dashboard/ubah_preventive_november/<?= $item['id']?>" style="color: black"><i class="fas fa-solid fa-pencil-alt"></i></a>
                            <a href="<?= base_url() ?>Dashboard/deleteReportPreventiveNovember/<?= $item['id']?>" onclick="return confirm('Hapus?');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                          </td>                          
                        </tr>
                        <?php } ?>
                        <?php endif; ?>                        
