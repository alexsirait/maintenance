                ...
                <div class="card-body">
                    <form class="" action="" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="" id="" cols="30" rows="11"></textarea>
                                    <small class="form-text text-danger danger"><?= form_error('applicable_job'); ?></small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <textarea id="criminal_desc" name="position_profile" cols="40" rows="5" class="form-control mb-3"></textarea>
                        </div>
                        <div class="form-row">
